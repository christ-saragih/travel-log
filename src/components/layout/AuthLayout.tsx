...
const AuthLayout = () => {
  return (
    <div className="bg-muted/30 flex min-h-screen w-full items-stretch px-4 md:px-20">
      <div className="container mx-auto grid flex-1 items-center gap-10 lg:grid-cols-2">
